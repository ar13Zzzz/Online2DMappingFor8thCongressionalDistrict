...
function insertDefaultCarouselSrc() {
    shuffleArray(tagaytayHeaderCarouselSrc);
    for (var i = 0; i < tagaytayHeaderCarouselSrc.length - 1; i++) {
        document.querySelector("#carouselTagaytayDefault .carousel-inner").innerHTML += '<div class="'+carouselContainerClass+'" > <img src="'+tagaytayHeaderCarouselSrc[i]+'" class="'+carouselClass+'" > </div>';
    }
}
